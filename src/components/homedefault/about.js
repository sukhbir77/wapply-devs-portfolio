...
const About = () => {
    const aboutQueryData = useStaticQuery(graphql`
        query AboutDefaultQuery {
            ...
            file(relativePath: {eq: "images/banner/person-image.png"}) {
                childImageSharp {
                        ...
                        <div className="inner">
                            <div className="content">
                                ...
                                <div className="button-group mt--30">
                                    {downloadButton && <a className="rn-button wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1000ms" href="/#contact"><span>{downloadButton}</span></a>}
                                </div>
                            </div>
                        </div>
                    </div>
